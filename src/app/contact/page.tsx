...
export default function ContactPage() {
  ...
  <div className="bg-[#5592BB] mt-10 shadow-2xl rounded-lg p-8 max-w-6xl mx-auto flex justify-between items-start gap-8">
  {/* Text Section */}
  <div className="flex-1">
    <h1 className="text-2xl font-bold text-[#00121f] mb-2">
      Download the Elenii Shepherd app
    </h1>
    <p className="mb-4 text-[#00121f]">
  ...
  <div className="flex-shrink-0">
    <img src="/QRcode.png" alt="QR code to download Elenii Shepherd app" className="max-w-xs w-full" />
  </div>
</div>
    </section>
  );
